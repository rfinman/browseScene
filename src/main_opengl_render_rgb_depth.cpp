...
//    pangolin::View& image_viewer = Display("image_viewer")
//            .SetAspect((float)width/(float)height)
//            .SetBounds(0.0,1,0.5,1,false);
...
//    TooN::Matrix<20,3>colours=  TooN::Data(89,	141,	242,
//                                           225,	243,	185,
//                                           98,	251,	148,
//                                           19,	90,	38,
//                                           224,	125,	32,
...
//    iu::ImageGpu_32f_C4* d_image_rgb     = new iu::ImageGpu_32f_C4(width,height);
//    iu::setValue(make_float4(0.0f),d_image_rgb,d_image_rgb->roi());
...
//    sprintf(trajectory_fileName,"../data/room_89_simple_data/room_89_simple_trajectory_random_poses_SE3_3x4.txt",
//            data_dir.c_str(),
//            obj_basename.c_str());

//    sprintf(openglmodelview_trajectory_fileName,"%s/%s_trajectory_random_poses_SE3_3x4_opengl.txt",
//            data_dir.c_str(),
//            obj_basename.c_str());

    ifstream SE3PoseFile(trajectory_fileName);

//    ofstream openglPoseFile(openglmodelview_trajectory_fileName);

    TooN::SE3<>T_wc;

    TooN::Matrix<3,4>T_wc4x4;

    char readlinedata[100];
